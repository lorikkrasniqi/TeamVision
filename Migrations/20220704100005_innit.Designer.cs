...
namespace VisionStore.Migrations
{
    ...
    [Migration("20220704100005_innit")]
    partial class innit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VisionStore.Areas.Identity.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VisionStore.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("VisionStore.Models.ContactUs", b =>
                {
            ...
            modelBuilder.Entity("VisionStore.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VisionStore.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VisionStore.Models.Products", b =>
                {
                    b.HasOne("VisionStore.Models.Category", "Category")
                        .WithMany("Products")
